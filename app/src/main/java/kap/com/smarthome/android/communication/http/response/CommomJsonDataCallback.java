...
public class CommomJsonDataCallback implements Callback{
    ...
    public CommomJsonDataCallback(DealHttpResponseHandle handle) {
    ...
    private void handleResponse(Object responseObj) {
        ...
        try {
            ...
            MyLogUtils.LogUtils(1,result.toString());
            if(mClass != null){
                ...
                mListener.onHttpFail(new MyOkHttpException(result.optInt(RESULT_CODE), result.optString(ERROR_MSG)));
            }
        } catch (Exception e) {
