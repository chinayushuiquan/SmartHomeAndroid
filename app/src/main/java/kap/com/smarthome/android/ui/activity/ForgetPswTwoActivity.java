...
public class ForgetPswTwoActivity extends  BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forget_psw_two);
        mClick_btn = (Button) findViewById(R.id.find_psw_btn);
        mClick_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ForgetPswTwoActivity.this, ForgetPswThreeActivity.class));
            }
        });
    }
